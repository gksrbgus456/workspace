package Java0426_class_part05;
/*
 * [데이터]
 * ("a001", "생명보험", "자동차보험", 30000);
	("a001", "생명보험", "운전자보험", 20000);
	("a001", "손해보험", "화재보험", 15000);
	("a001", "손해보험", "해상보험", 25000);
...
public class Java077_class {
	...
	is[1] = new Insurance("a001", "생명보험", "운전자보험", 20000);
	is[2] = new Insurance("a001", "손해보험", "화재보험", 15000);
	is[3] = new Insurance("a001", "손해보험", "해상보험", 25000);
